    ...
    private String getPageResult(String urlPath) throws IOException {
        ...
        try {
            ...
            if(myIp==null)
                ...
                connection = (HttpURLConnection) url.openConnection(new Proxy(Proxy.Type.HTTP,new InetSocketAddress(myIp,myPort)));//new Proxy(Proxy.Type.HTTP,new InetSocketAddress(myIp.getIp(),myIp.getPort()))
